...
@section('content')
    ...
    <form action="/form" method="POST">
        ...
        <label for="skills_interested">What specific skills or techniques are you most interested in learning or improving?</label>
        <textarea id="skills_interested" name="skills_interested" required></textarea><br><br>

        <label for="specializations_interested">Are you interested in any particular specializations within nail art, such as gel nails, acrylics, or nail design?</label>
        <textarea id="specializations_interested" name="specializations_interested" required></textarea><br><br>

        <label for="course_certification_importance">How important is it for you that the course provides certification or accreditation upon completion?</label>
        <textarea id="course_certification_importance" name="course_certification_importance" required></textarea><br><br>

        <label for="course_format_preference">Do you have any specific preferences for the format of the course, such as online, in-person, or hybrid?</label>
        <textarea id="course_format_preference" name="course_format_preference" required></textarea><br><br>

        <label for="support_mentorship_expectation">What level of support and mentorship do you expect from the course instructors?</label>
        ...
        <label for="long_term_goals">What are your long-term goals with nail art? Are you considering starting a business, working in a salon, or something else?</label>
